 ...
 * Original class from https://github.com/siacs/Conversations/blob/master/src/main/java/eu/siacs/conversations/utils/MimeUtils.java
 */
public final class MimeUtils {
    ...
    /**
     *
     * @param extension extension you want to check for
     * @return true if the extension is for a video file
     */
    public static boolean isFileVideo(String extension)
    {
        return (guessMimeTypeFromExtension(extension).contains("video"));
    }

    /**
     *
     * @param extension extension you want to check for
     * @return true if the extension is for an image file
     */

    public static boolean isFileImage(String extension)
    {
        return (guessMimeTypeFromExtension(extension).contains("image"));
    }

    /**
     *
     * @param extension extension you want to check for
     * @return true if the extension is for an audio file
     */
    public static boolean isFileAudio(String extension)
    {
        return (guessMimeTypeFromExtension(extension).contains("audio"));
    }

    /**
     *
     * @param extension extension you want to check for
     * @return true if the extension is for an office file.
     */
    public static boolean isFileDocument(String extension)
    {
        if( extension.equals("doc") ||extension.equals("docx") || extension.equals("dotx") || extension.equals("xls") ||
                extension.equals("xlt") || extension.equals("xlsx") || extension.equals("xltx")  || extension.equals("ppt") ||
                extension.equals("pot") || extension.equals("pps") || extension.equals("pptx") || extension.equals("potx") ||
                extension.equals("ppsx") || extension.equals("pdf"))
        {
            return true;
        }else
        {
